          ...
          <Box
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', width: '100%', justifyContent: 'space-around' }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
                    ...
                    <Typography variant="body1" sx={{flexShrink:"100"}}>
                        Our primary aim is to democratize access to expert financial advice by leveraging technology, enabling people from all walks of life to build wealth and achieve their financial goals. We strive to create user-friendly platforms that simplify complex financial concepts, making them accessible and understandable for everyone.
                    </Typography>
                </Box>

                <Box sx={{ display: 'flex', alignItems: 'center', width: '100%', justifyContent: 'right' }}>
                <Typography variant="body1" sx={{flexShrink:"100"}}>
                We are committed to fostering financial literacy and education by providing valuable resources, workshops, and personalized guidance to empower our clients in making informed financial decisions. Our mission is to transform the way people approach personal finance and help them develop a strong foundation for a secure financial future.
                </Typography>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
                    ...
                    <Typography variant="body1" sx={{flexShrink:"100"}}>
                    At the heart of our mission is the continuous innovation and improvement of our services, ensuring that we stay at the forefront of the ever-evolving financial landscape. We aim to develop new technologies and adapt to emerging trends, providing our clients with the most effective financial management tools and strategies.
                    </Typography>
                </Box>
            </Box>
        </Box>
        ...
        >
          ...
          <Box
            ...
            <List sx={{ listStyleType: 'disc', pl: 4 , fontSize:'1.2rem'}}>
                <ListItem sx={{ display: 'list-item' }}>Programmer</ListItem>
                <ListItem sx={{ display: 'list-item' }}>ENU</ListItem>
                <ListItem sx={{ display: 'list-item' }}>Dana</ListItem>
